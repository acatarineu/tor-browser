...
class nsExternalLoadURIHandler final : public nsIHelperAppWarningLauncher {
 public:
  ...
  nsExternalLoadURIHandler(BrowsingContext* aBrowsingContext, nsIURI* aURI,
...
NS_IMETHODIMP nsExternalLoadURIHandler::ContinueRequest() {
  ...
  return chooser->Ask(mHandlerInfo, mBrowsingContext, mURI,
...
nsExternalHelperAppService::LoadURI(nsIURI* aURI,
  ...
  RefPtr<nsExternalLoadURIHandler> h =
      new nsExternalLoadURIHandler(aBrowsingContext, uri, handler);
  if (!h) {
    return NS_ERROR_OUT_OF_MEMORY;
  }
