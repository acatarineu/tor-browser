...
const {getLocale} = ChromeUtils.import("resource://torbutton/modules/utils.js");
...
var TorStrings = {
  ...
  */
  securityLevel : function() {
    let tsb = new TorStringBundle(['chrome://torbutton/locale/torbutton.dtd'], "torbutton.prefs.sec_");
  ...
  */
  settings : function() {
    ...
    let tsb = new TorStringBundle(['chrome://torlauncher/locale/network-settings.dtd'], "");
    let getString = function(key, fallback) {
      return tsb.getString(key, fallback);
    };
    ...
    let retval = {
      ...
      torPreferencesHeading : getString("torPreferences.torSettings", "Tor Settings"),
      torPreferencesDescription : getString("torPreferences.torSettingsDescription", "Tor Browser routes your traffic over the Tor Network, run by thousands of volunteers around the world." ),
      learnMore : getString("torPreferences.learnMore", "Learn More"),
      bridgesHeading : getString("torPreferences.bridges", "Bridges"),
      bridgesDescription : getString("torPreferences.bridgesDescription", "Bridges help you access the Tor Network in places where Tor is blocked. Depending on where you are, one bridge may work better than another."),
      useBridge : getString("torPreferences.useBridge", "Use a bridge"),
      selectBridge : getString("torsettings.useBridges.default", "Select a bridge"),
      requestBridgeFromTorProject : getString("torsettings.useBridges.bridgeDB", "Request a bridge from torproject.org"),
      requestNewBridge : getString("torPreferences.requestNewBridge", "Request a New Bridge\u2026"),
      provideBridge : getString("torPreferences.provideBridge", "Provide a bridge"),
      provideBridgeDirections : getString("torsettings.useBridges.label", "Enter bridge information from a trusted source."),
      provideBridgePlaceholder : getString("torsettings.useBridges.placeholder", "type address:port (one per line)"),
      advancedHeading : getString("torPreferences.advanced", "Advanced"),
      advancedDescription : getString("torPreferences.advancedDescription", "Configure how Tor Browser connects to the internet."),
      ...
      proxyAddressPlaceholder : getString("torsettings.useProxy.address.placeholder", "IP address or hostname"),
      ...
      proxyUsernamePasswordPlaceholder : getString("torsettings.optional", "Optional"),
      useFirewall : getString("torsettings.firewall.checkbox", "This computer goes through a firewall that only allows connections to certain ports"),
      allowedPorts : getString("torsettings.firewall.allowedPorts", "Allowed Ports"),
      allowedPortsPlaceholder : getString("torPreferences.firewallPortsPlaceholder", "Comma-seperated values"),
      requestBridgeDialogTitle : getString("torPreferences.requestBridgeDialogTitle", "Request Bridge"),
      submitCaptcha : getString("torsettings.useBridges.captchaSubmit", "Submit"),
      contactingBridgeDB : getString("torPreferences.requestBridgeDialogWaitPrompt", "Contacting BridgeDB. Please Wait."),
      solveTheCaptcha : getString("torPreferences.requestBridgeDialogSolvePrompt", "Solve the CAPTCHA to request a bridge."),
      captchaTextboxPlaceholder : getString("torsettings.useBridges.captchaSolution.placeholder", "Enter the characters from the image"),
      incorrectCaptcha : getString("torPreferences.requestBridgeErrorBadSolution", "The solution is not correct. Please try again."),
      showTorDaemonLogs : getString("torPreferences.viewTorLogs", "View the Tor logs."),
      showLogs : getString("torPreferences.viewLogs", "View Logs\u2026"),
      torLogDialogTitle : getString("torPreferences.torLogsDialogTitle", "Tor Logs"),
  ...
  */
  ...
  preferenceKeys : {
    ...
    recommendedBridgeType : "extensions.torlauncher.default_bridge_recommended_type",
  },
