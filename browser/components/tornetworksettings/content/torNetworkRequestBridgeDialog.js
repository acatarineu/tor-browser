...
const TorRequestBridgeDialog = (function() {
  const selectors = {
    ...
    DialogDescription:
      "description#torNetworkSettings-requestBridge-description",
    ...
    CaptchaEntryTextbox:
      "textbox#torNetworkSettings-requestBridge-captchaTextbox",
    RefreshCaptchaCommand:
      "command#torNetworkSettings-requestBridge-refreshCaptchaCommand",
    RefreshCaptchaButton:
      "button#torNetworkSettings-requestBridge-refreshCaptchaButton",
    IncorrectCaptchaHbox:
      "hbox#torNetworkSettings-requestBridge-incorrectCaptchaHbox",
    IncorrectCaptchaLabel:
      "label#torNetworkSettings-requestBridge-incorrectCaptchaError",
  }; /* selectors */
  ...
  let retval = {
    ...
    _populateXUL(dialog) {
      ...
      this._dialog.setAttribute(
        "title",
        TorNetworkSettingsStrings.requestBridgeDialogTitle
      );
      ...
      this._submitButton.setAttribute(
        "label",
        TorNetworkSettingsStrings.submitCaptcha
      );
      ...
      this._dialogDescription.textContent =
        TorNetworkSettingsStrings.contactingBridgeDB;
      ...
      this._captchaEntryTextbox.setAttribute(
        "placeholder",
        TorNetworkSettingsStrings.captchaTextboxPlaceholder
      );
      ...
      this._incorrectCaptchaLabel.setAttribute(
        "value",
        TorNetworkSettingsStrings.incorrectCaptcha
      );
    ...
    _setCaptchaImage(uri) {
      ...
      this._dialogDescription.textContent =
        TorNetworkSettingsStrings.solveTheCaptcha;
    ...
    init(dialog) {
      ...
      window.setTimeout(function() {
        TorRequestBridgeDialog._populateXUL(dialog);
      }, 0);
    },
    ...
    */
    onSubmitCaptcha() {
      ...
      TorBridgeDB.submitCaptchaGuess(captchaText)
        ...
        .catch(aError => {
          ...
          TorRequestBridgeDialog._incorrectCaptchaHbox.style.visibility =
            "visible";
        });
    },
    ...
    openDialog(aProxyURI, aCloseCallback) {
      let self = this;
      this._proxyURI = aProxyURI;
      gSubDialog.open(
        "chrome://browser/content/tornetworksettings/torNetworkRequestBridgeDialog.xul",
        "resizable=yes",
        self,
        arg => {
          self.close();
