...
TorStringBundle.prototype.getString = function(key, fallback) {
  if (key) {
    try {
      return this.localizeEntity(this._bundleURLs, `torbutton.prefs.sec_${key}`);
    } catch (e) { }
  }
...
const TorNetworkSettingsStrings = function() {
  ...
  let retval = {
    ...
    torNetworkSettingsDescription : getString(null, "Tor Browser connects you to the Tor Network run by thousands of volunteers around the world."),
    ...
    requestBridgeFromTorProject : getString(null, "Request a bridge from torproject.org"),
    requestNewBridge : getString(null, "Request a New Bridge\u2026"),
    provideBridge : getString(null, "Provide a bridge I know"),
    provideBridgeDirections : getString(null, "Enter bridge information from a trusted source."),
    provideBridgePlaceholder : getString(null, "type address:port (one per line)"),
    advancedHeading : getString(null, "Advanced"),
    advancedDescription : getString(null, "Configure how Tor Browser connects to the internet."),
    ...
    useFirewall : getString(null, "This computer goes through a firewall that only allows connections to certain ports"),
    ...
    captchaTextboxPlaceholder : getString(null, "Enter the characters from the image"),
    incorrectCaptcha : getString(null, "The solution is not correct. Please try again."),
  };
